...
Class consommation extends base_module
{
	...
	{		
		...
		$this->get_html_tpl = $this
						...
						->assign_var("prix_compteur_eau", $this->prix_location_compteur_eau)
						->assign_var("prix_compteur_elec_jour", $this->prix_location_compteur_elec)
						->assign_var("prix_compteur_elec_nuit", $this->prix_location_compteur_elec)
						->assign_var("prix_compteur_gaz", $this->prix_location_compteur_gaz)
